...
while running:
    ...
    # Render the world
    screen.blit(world_surface, (-camera.get_offset().x, -camera.get_offset().y))
    ...
    # Render player
    player_screen_x = player_pos.x - camera.get_offset().x
    player_screen_y = player_pos.y - camera.get_offset().y
